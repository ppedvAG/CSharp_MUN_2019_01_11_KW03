...
namespace Fahrzeugpark
{
    ...
    public abstract class Fahrzeug
    {
        ...
        public static string ZähleFahrzeuge()
        {
        ...
        {
            if (this.MotorLäuft)
                return $"'{this.Name}' fährt mit {this.AktGeschwindigkeit} von {this.MaxGeschwindigkeit}km/h und kostet {this.Preis} Euro.";
            else
                return $"'{this.Name}' könnte mit {this.MaxGeschwindigkeit} km/h fahren und kostet {this.Preis} Euro.";
        }
